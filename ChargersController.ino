 ...
 * ADD THE OPTION TO DISSABLE BUT FOR DISSABLE CAN BE DISCONNECTED,
 * 
 * 
 ...
 * 
 * I DID A MOSFET CIRCUIT FOR THIS SYSTEM AND IS HERE:
 * 
 * https://drive.google.com/file/d/1A85BqsoagbjsvYU76nDeSqK2Gb5rMe1O/view?usp=drivesdk
 * 
 * MUST BE ADJUSTED ACCORDING DEVICE CURRENT AND MOSFET USED, THERE RESISTOR CAN MORE AND LESS FIT  
 * AN IRF520.
 * 
 * CIRCUITS NEED CAPACITORS AND GROUND RESISTORS TO MAKE 60 HRZ LOW PASS FILTER, OTHER RESISTOR TO 
 * GROUND BIG TO DISCHARGE THE SIGNAL. 
 * 
 * FOR EXAMPLE ONE RESISTOR 12K  TO SIGNAL IN (BATTERY AND DEVICES VOLTAGE) AND 220 nf capacitor and 
 ...
 * 
 * ARDUINO IS CHARGING FROM THE BATTERY  USING AN LM 785 OR 340 WHICH IS THE SIMPLEST OPTION.
 " 
 *THE MICROCONTROLLER SEND ALL THE DATA USING FIRMATA AND WITH PHYTON IS
 " HANDLED TO MAKE HISTORIAL OF INFO AND GRAPHICS.
 * 
...
const float VOLTAGE_DIVIDER_R_TOP = 17.8 ;          // THESE ARE THE VOLTAGE DIVIDER RESISTANCE TO SEND VOLTAGE BATTERY TO
const float VOLTAGE_DIVIDER_R_GROUND = 10;          // THE ANALOG PIN DIRECTLY
...
const float VOLTS_FACTOR_IN_OP = 1 ;  // THIS IS THE MEASURE OF VOUI IN THE OPERATIONAL AMPLIFIER ACCROSS A CAPACITOR BECAUSE IS NEGATIVE
                                                 // CAPACITOR MUST BE SMALL 22 nf DON'T NEEDS RESISTANCE SINCE IS LOW, LESS THAN 5
